...
# Make Robomaster fire his blaster every time he sees a person.
# Set the zoom value update from 1 to 4 for farther distances.
...
# Call up the blaster_fire_example function.
# Be sure to properly indent the function or it won't work.
